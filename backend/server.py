...
from routers import (
    ...
    analytics, artists, settings as settings_router,
)
...
for r in (auth, music, playlists, home, radio, bible, neno, churches, billing, admin, analytics, artists, settings_router):
