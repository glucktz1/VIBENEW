...
const styles = StyleSheet.create({
  ...
  artWrap: { flex: 1, minHeight: 0, alignItems: "center", justifyContent: "center", marginTop: SPACING.md, paddingHorizontal: SPACING.lg },
  art: { width: "100%", aspectRatio: 1, maxWidth: 360, flexShrink: 1, borderRadius: RADIUS.xl, backgroundColor: COLORS.surface },
  ...
  meta: { flexDirection: "row", alignItems: "center", paddingHorizontal: SPACING.lg, marginTop: SPACING.md },
  ...
  controls: { flexDirection: "row", alignItems: "center", justifyContent: "space-evenly", marginTop: SPACING.md, paddingHorizontal: SPACING.xl },
